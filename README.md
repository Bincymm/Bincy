                ...
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Server Administrator</h3>
                            <div class="subheading mb-3">Altisource Solutions Pvt Ltd</div>
                            <p>Install, configure, and maintain various types of hardware and software, which often involves creating user accounts, carrying out backup and recovery functions, and monitoring the performance of servers at all times.</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">June 2005 - September  2011</span></div>
                    </div>
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            </div>
                ...
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            ...
                            <div class="subheading mb-3">Master of Technology</div>
                            <div>Telecommunication Engineering</div>
                            <p>CGPA: 7.3</p>
                        </div>
